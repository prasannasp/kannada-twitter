...
define('ENCRYPTION_KEY', 'Change This!-aSDFsdfa56sd4fa(*&dadSDF56as4d@#$F');
...
define('MYSQL_USERS', 'OFF');
 //If you select MySQL Users 'ON' then delete two //s in next two lines and fill db username, password and db name
